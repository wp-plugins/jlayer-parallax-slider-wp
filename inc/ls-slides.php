    ...
    <div class="sp-hide">
        <div id="sp-ls-slide-form">
            <div class="ls-admin-icon-bar">
                ...
                <a id="ls-slide-title" class="ls-admin-icon thickbox" title="Add a Title" href="#TB_inline?height=155&width=500&inlineId=ls-admin-text">A</a>
                ...
                <div id="ls-admin-video" style="display: none;">
                    <form method="post">
                        ...
                        <p class="sp-form-row">
                            ...
                            <span class="sp-video-logo" id="ti-youtube-icon"><img src="<?php bloginfo("template_url"); ?>/admin/images/youtube-icon.png" title="YouTube"/></span>
                            <span class="sp-video-logo" id="ti-vimeo-icon"><img src="<?php bloginfo("template_url"); ?>/admin/images/vimeo-icon.png" title="Vimeo"/></span>
                        </p>
                        <p class="sp-form-row">
